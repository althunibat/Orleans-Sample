...
namespace Godwit.Silo.Extensions {
    /// <summary>
    ...
    public static class HostBuilderExtensions {
        ...
        public static IHostBuilder UseIf(
            ...
            if (condition) hostBuilder = action(hostBuilder);
        ...
        public static IHostBuilder UseIf(
            ...
            if (condition(hostBuilder)) hostBuilder = action(hostBuilder);
        ...
        ///     If set to <c>true</c> the <paramref name="ifAction" /> is executed, otherwise the
        ///     <paramref name="elseAction" /> is executed.
        /// </param>
        ...
        public static IHostBuilder UseIfElse(
            ...
            if (ifAction is null) throw new ArgumentNullException(nameof(ifAction));

            if (elseAction is null) throw new ArgumentNullException(nameof(elseAction));
        ...
        /// <param name="hostBuilder">The host builder.</param>
        /// <param name="condition">
        ///     If <c>true</c> is returned the <paramref name="ifAction" /> is executed, otherwise the
        ///     <paramref name="elseAction" /> is executed.
        /// </param>
        /// <param name="ifAction">The action used to add to the host builder if the condition is <c>true</c>.</param>
        /// <param name="elseAction">The action used to add to the host builder if the condition is <c>false</c>.</param>
